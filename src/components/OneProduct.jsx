...
function OneProduct() {
  ...
  useEffect(() => {
    oneProductContext.showOneProduct(oneProductContext.identification, oneProductContext.setOneProduct);
  }, []);

  return (
    <>
      {oneProductContext.oneProduct != null ? (
        <div key={oneProductContext.oneProduct._id} className="mainContainer">
